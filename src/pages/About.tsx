          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center fade-in">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-primary-foreground drop-shadow-lg">
                About Furu Holmes LLC
              </h1>
              <p className="text-xl text-accent">
                Your trusted partner in transforming houses into beautiful,
                functional dream homes
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="bg-muted/50 rounded-lg p-8 space-y-6">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <span>
                        Over 10 years of experience in home remodeling
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-3"></div>
                    ...
                    <li className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-3"></div>
                      <span>
                        Commitment to using quality materials and techniques
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-3"></div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <Card
                  key={index}
                  className="text-center hover:shadow-lg transition-shadow duration-300 fade-in"
                >
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 fade-in">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our experienced professionals are dedicated to bringing your
                vision to life
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center fade-in">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    With over 15 years in construction and remodeling, John
                    brings expertise and passion to every project.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center fade-in">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Sarah's eye for design and attention to detail ensures every
              ...
              <Card className="text-center fade-in">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Mike ensures every project runs smoothly, on time, and
                    within budget from start to finish.
                  </p>
                </CardContent>
              </Card>
            </div>
