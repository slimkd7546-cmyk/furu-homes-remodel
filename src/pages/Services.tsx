  ...
  const services = [
    {
      ...
      description:
        "Transform your kitchen into the heart of your home with our comprehensive remodeling services.",
      features: [
    ...
    },
    {
      ...
      description:
        "Create a luxurious spa-like retreat with our expert bathroom renovation services.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete home transformations that maximize space, functionality, and style throughout your entire home.",
      features: [
    ...
    },
    {
      ...
      description:
        "Unique, personalized renovation solutions tailored to your specific vision and lifestyle needs.",
      features: [
  ...
  const process = [
    {
      ...
      description:
        "We meet with you to discuss your vision, needs, and budget for your project.",
    },
    {
      step: "2",
      title: "Design & Planning",
      description:
        "Our team creates detailed plans and 3D renderings to visualize your new space.",
    },
    {
      step: "3",
      title: "Material Selection",
      description:
        "We help you choose the perfect materials, fixtures, and finishes for your project.",
    },
    {
      step: "4",
      title: "Construction",
      description:
        "Our skilled craftsmen bring your vision to life with quality workmanship.",
    },
    {
      step: "5",
      title: "Final Walkthrough",
      description:
        "We ensure every detail meets your expectations before project completion.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our luxury home remodeling services: kitchen, bathroom, whole home, and custom renovations by Furu Holmes LLC."
        />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center fade-in">
              ...
              <p className="text-xl text-accent">
                Comprehensive home remodeling and renovation services to
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            {services.map((service, index) => (
              <div
                key={index}
                className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24 ${index % 2 === 1 ? "lg:grid-flow-col-dense" : ""}`}
              >
                <div
                  className={`fade-in ${index % 2 === 1 ? "lg:col-start-2" : ""}`}
                >
