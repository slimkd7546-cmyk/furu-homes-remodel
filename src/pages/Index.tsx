  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform your house into a dream home with Furu Holmes LLC. Expert kitchen remodeling, bathroom renovations, and whole home remodeling services." />
        <meta property="og:title" content="Furu Holmes LLC - Professional Home Remodeling" />
      ...
      <div className="min-h-screen bg-[#18120a] text-[#fff9e1]">
        <Header />
        {/* Hero Section */}
        <section className="pt-20 pb-16 relative overflow-hidden" style={{background: 'linear-gradient(135deg, #18120a 0%, #3e2723 100%)'}}>
          <div className="absolute inset-0 wood-texture opacity-10"></div>
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center fade-in">
              <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight text-[#ffe082] drop-shadow-lg">
                Transforming Houses Into
                <span className="block text-[#ffb300] font-extrabold drop-shadow-lg"> Dream Homes</span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-[#fff9e1] font-semibold max-w-2xl mx-auto drop-shadow-md">
                Expert home remodeling and renovation services with quality craftsmanship you can trust
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-[#ffb300] hover:bg-[#ffe082] text-[#3e2723] font-bold px-8 shadow-lg">
